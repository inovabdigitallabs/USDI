...
contract BEP20USDI is Pausable, IBEP20, Ownable {
    ...
    function blacklist(address account) external onlyOwner {
        require(
            !_blacklist[account],
            "StableCoin: Account already blacklisted"
        );
    ...
    function unblacklist(address account) external onlyOwner {
        require(_blacklist[account], "StableCoin: Account is not blacklisted");
    ...
    function _approve(
        ...
        require(!_blacklist[owner], "Approver is blacklisted");
